    ...
    pub mod client {
        ...
        impl SoftDropT {
            pub fn pack<'b>(
                ...
                let repeats = self.repeats;
                SoftDrop::create(_fbb, &SoftDropArgs { repeats })
            }
        }
        ...
        impl HorizontalT {
            pub fn pack<'b>(
                ...
                let right = self.right;
                Horizontal::create(_fbb, &HorizontalArgs { right })
            }
        }
        ...
        impl<'a> PlayerAction<'a> {
            ...
            pub fn action_type(&self) -> PlayerActions {
                ...
                unsafe {
                    self._tab
                        .get::<PlayerActions>(
                            PlayerAction::VT_ACTION_TYPE,
                            Some(PlayerActions::NONE),
                        )
                        .unwrap()
                }
            }
            ...
            fn run_verifier(
                ...
                v.visit_table(pos)?
                    .visit_union::<PlayerActions, _>(
                        ...
                        false,
                        |key, v, pos| match key {
                            PlayerActions::RotateCW => v
                                .verify_union_variant::<flatbuffers::ForwardsUOffset<RotateCW>>(
                                    "PlayerActions::RotateCW",
                                    pos,
                                ),
                            PlayerActions::RotateCCW => v
                                .verify_union_variant::<flatbuffers::ForwardsUOffset<RotateCCW>>(
                                    "PlayerActions::RotateCCW",
                                    pos,
                                ),
                            PlayerActions::Rotate180 => v
                                .verify_union_variant::<flatbuffers::ForwardsUOffset<Rotate180>>(
                                    "PlayerActions::Rotate180",
                                    pos,
                                ),
                            PlayerActions::Hold => v
                                .verify_union_variant::<flatbuffers::ForwardsUOffset<Hold>>(
                                    "PlayerActions::Hold",
                                    pos,
                                ),
                            PlayerActions::HardDrop => v
                                .verify_union_variant::<flatbuffers::ForwardsUOffset<HardDrop>>(
                                    "PlayerActions::HardDrop",
                                    pos,
                                ),
                            PlayerActions::SoftDrop => v
                                .verify_union_variant::<flatbuffers::ForwardsUOffset<SoftDrop>>(
                                    "PlayerActions::SoftDrop",
                                    pos,
                                ),
                            PlayerActions::Horizontal => v
                                .verify_union_variant::<flatbuffers::ForwardsUOffset<Horizontal>>(
                                    "PlayerActions::Horizontal",
                                    pos,
                                ),
                            _ => Ok(()),
        ...
        impl<'a: 'b, 'b> PlayerActionBuilder<'a, 'b> {
            ...
            pub fn add_action_type(&mut self, action_type: PlayerActions) {
                self.fbb_.push_slot::<PlayerActions>(
                    PlayerAction::VT_ACTION_TYPE,
                    action_type,
                    PlayerActions::NONE,
                );
            ...
            pub fn add_action(
                &mut self,
                action: flatbuffers::WIPOffset<flatbuffers::UnionWIPOffset>,
            ) {
                self.fbb_
                    .push_slot_always::<flatbuffers::WIPOffset<_>>(PlayerAction::VT_ACTION, action);
            }
            #[inline]
            pub fn new(
                _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
            ) -> PlayerActionBuilder<'a, 'b> {
                let start = _fbb.start_table();
                PlayerActionBuilder {
                    fbb_: _fbb,
                    start_: start,
        ...
        impl<'a> PlayerActionList<'a> {
            ...
            pub fn unpack(&self) -> PlayerActionListT {
                ...
                PlayerActionListT { actions }
            }

            #[inline]
            pub fn actions(
                &self,
            ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<PlayerAction<'a>>>>
            {
                // Safety:
                // Created from valid Table for this object
                // which contains a valid value in this slot
                unsafe {
                    self._tab.get::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<PlayerAction>>,
                    >>(PlayerActionList::VT_ACTIONS, None)
                }
            }
        }
            ...
            fn run_verifier(
                ...
                v.visit_table(pos)?
                    .visit_field::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<PlayerAction>>,
        ...
        pub struct PlayerActionListArgs<'a> {
            pub actions: Option<
                flatbuffers::WIPOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<PlayerAction<'a>>>,
                >,
            >,
        }
        impl<'a> Default for PlayerActionListArgs<'a> {
            #[inline]
            fn default() -> Self {
                PlayerActionListArgs { actions: None }
            }
        }
        ...
        impl<'a: 'b, 'b> PlayerActionListBuilder<'a, 'b> {
            ...
            pub fn add_actions(
                ...
                actions: flatbuffers::WIPOffset<
                    flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<PlayerAction<'b>>>,
                >,
            ) {
                self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                    PlayerActionList::VT_ACTIONS,
                    actions,
                );
            }
            #[inline]
        ...
        impl PlayerActionListT {
            pub fn pack<'b>(
                ...
                PlayerActionList::create(_fbb, &PlayerActionListArgs { actions })
            }
        }
        #[inline]
        ...
        pub fn root_as_player_action_list(
            buf: &[u8],
        ) -> Result<PlayerActionList, flatbuffers::InvalidFlatbuffer> {
        ...
        pub fn size_prefixed_root_as_player_action_list(
            buf: &[u8],
        ) -> Result<PlayerActionList, flatbuffers::InvalidFlatbuffer> {
        ...
        pub unsafe fn size_prefixed_root_as_player_action_list_unchecked(
            buf: &[u8],
        ) -> PlayerActionList {
        ...
        #[inline]
        pub fn finish_size_prefixed_player_action_list_buffer<'a, 'b>(
            fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
            root: flatbuffers::WIPOffset<PlayerActionList<'a>>,
        ) {
